...
INSERT INTO `atelier` (`theme`, `nb_places`, `responsable`, `date_enregistrement`, `date_heure`, `duree`, `nb_participants`) VALUES 
('Nouveau thème', 5, 1, '2024-04-21', '2024-04-22 10:00:00', 2, 0),
('Atelier test', 8, 2, '2024-04-21', '2024-04-22 14:00:00', 3, 0),
('Atelier démo', 10, 1, '2024-04-22', '2024-04-23 09:00:00', 1, 0),
('Atelier exemple', 6, 2, '2024-04-23', '2024-04-24 11:00:00', 2, 0),
('Atelier pratique', 12, 1, '2024-04-24', '2024-04-25 13:00:00', 2, 0);


INSERT INTO `client` (`nom`, `prenom`, `mdp`, `email`, `date_naissance`, `adresse`, `cp`, `ville`, `mobile`, `civilite`) VALUES
('Dupont', 'Jean', '123456', 'jean.dupont@example.com', '1990-01-01', '1 rue des Lilas', '75001', 'Paris', '0612345678', 'M.'),
('Martin', 'Sophie', 'abcdef', 'sophie.martin@example.com', '1985-05-05', '2 avenue des Roses', '69001', 'Lyon', '0623456789', 'Mme'),
('Dubois', 'Pierre', 'password', 'pierre.dubois@example.com', '1995-10-10', '3 place du Marché', '33000', 'Bordeaux', '0634567890', 'M.'),
('Lefebvre', 'Camille', 'qwerty', 'camille.lefebvre@example.com', '2000-12-12', '4 rue de la Paix', '44000', 'Nantes', '0645678901', 'Mme'),
('Moreau', 'Luc', 'azerty', 'luc.moreau@example.com', '1992-03-15', '5 boulevard Voltaire', '59000', 'Lille', '0656789012', 'M.');




INSERT INTO `responsable` (`nom`, `prenom`, `mdp`, `login`) VALUES
('Garcia', 'Julie', 'qwerty', 'jgarcia'),
('Martin', 'Thomas', '123456', 'tmartin');
